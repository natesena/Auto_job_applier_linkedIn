...
# Your legal name
first_name = "Nathaniel"                 # Your first name in quotes Eg: "First", "Sai"
middle_name = "Ashford"            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Sena"                # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "7608559652"        # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city?
current_city = "New York"                  # Los Angeles, San Francisco, etc.
'''
